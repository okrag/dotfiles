...
# def update_package_count(default: int | None) -> None:
#     packages: int = default if default != None else int(
#         subprocess.run(
#             [sys.argv[1], "packages", "--no_config" "--package_managers", "off"],
...
if __name__ == "__main__":
    ...
    update_splash()
    # update_package_count(int(sys.argv[2]) if len(sys.argv) >= 3 else None)
